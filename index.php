<?php 
    ...
    $comando = $con->prepare('SELECT * FROM anuncio ORDER BY id_anuncio DESC');
    $comando->execute();
...
<body id="body">
    ...
    <header>
        ...
        <div class="icon__profile">
            <a href="./pantallas/pantalla_perfil.php"><i class="fa-regular fa-circle-user"></i></a>
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            <a href="./pantallas/pantalla_mis-anuncios.php">
                <div class="option">
    ...
    <main>
        <div class="busqueda">
            <form action="./pantallas/pantalla_busqueda.php" method="POST">
